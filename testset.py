...
class listener(tweepy.StreamListener):
    ...
    def on_data(self, data):
        if 'retweeted_status' not in data:
            ...
            result = db.testSet.insert_one({"tweet": processedTweet,"location": geo,"username":username,"userLocation":userLocation})
...
twitterStream.filter(languages=["en"],track=['ugly black','muslim terrorist','stopislam','black nigguh','dyke','fag','bitch'])
